...
function Footer() {
  ...
  function handleSubmit(){
    ...
    fetch('https://module-test-f9e4e-default-rtdb.asia-southeast1.firebasedatabase.app/user.json',{
      method: 'POST',
      headers: {
  ...
  return (
    <div className="main-footer-container">
      <div className="footer-1">
        <h2 className="brandName">Acciojob</h2>
      ...
      <div className="footer-2">
        <div className="footer-row">
          <div className="footer-section-column">
            ...
            <p className="about-us">Carrier</p>
            <p className="about-us">We are hiring</p>
          ...
          <div className="footer-section-column">
            ...
            <p className="about-us">Business Marketing</p>
            <p className="about-us">User Analytic</p>
            <p className="about-us">Live Chat</p>
            <p className="about-us">Unlimited Support</p>
          </div>
          <div className="footer-section-column">
            <h5  className="footer-header">Resources</h5>
            <p className="about-us">IOS & Android</p>
            <p className="about-us"> Watch a Demo</p>
            <p className="about-us">Customers</p>
            <p className="about-us">API</p>
          </div>
          <div className="footer-section-column">
            <h5 className="footer-header"> Get In Touch</h5>
            <input type='text' placeholder="Your Email" label="Email" className="email-input" value={userEmail} onChange={(e) => setUserEmail(e.target.value)}/>
            <button onClick={()=>handleSubmit()} className="subscribe-btn">Subscribe</button>
            <p className="about-us">Lorem impsum dolor amit</p>
          </div>
        </div>
      </div>
      <div className="end-footer">Made With ❤️ at Acciojob</div>
    </div>
  );
}
